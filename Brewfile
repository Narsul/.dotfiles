...
cask "chromium"                               # Chome browser
# cask "coconutbattery"                         # status of iOS and macbook battery
...
cask "ngrok"                                 # https tunneling for development
...
cask "pocket-casts"                           # Podcasts client
...
cask "little-snitch"                          # filewall for macOS
cask "micro-snitch"                           # detect microphone use
cask "microsoft-office"                       # Microsoft Word, Excel etc.
cask "parallels"                              # virtualization engine
cask "setapp"                                 # collection of apps with subscription
...
cask "qlmobi"                                 # renders various ebook formats used on kindle readers
...
mas "Telegram", id: 747648890                 # chat
# mas "Trello", id: 1278508951                  # productivity tool
...
# mas "WaterMinder", id: 1415257369             # reminder to drink water
